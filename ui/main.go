...
func (g *Game) ChangeState(stateName string) {
	...
	case STATE_MAIN_GAME:
		...
		spikeFloor := cards.NewTorchtail(mm.defaultGamestate) //cards.NewDamageEndturnCurse(mm.defaultGamestate) //cards.NewSpikeFloor(mm.defaultGamestate)
		// lair := cards.NewGoblinSmallLairArea(mm.defaultGamestate)
		// heal := item.NewHealingPotion(defaultGamestate)
		ll := append([]cards.Card{}, &spikeFloor)
